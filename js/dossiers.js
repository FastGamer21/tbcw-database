...
// НОВАЯ ФУНКЦИЯ ДЛЯ ГЕНЕРАЦИИ LIVE PREVIEW
function updateLivePreview() {
    ...
    document.querySelectorAll('.report-entry').forEach(entry => {
        ...
        // Используем глобальный парсер из dossiers.js
...
function setupSubmitControls() {
    ...
    tabBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // Если нажали на Превью, обновляем данные на лету
